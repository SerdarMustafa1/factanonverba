...
{
    public class BuildMyTalentOAuthLinkedInHandler : OAuthHandler<OAuthOptions>
    {
        ...
        public BuildMyTalentOAuthLinkedInHandler(IOptionsMonitor<OAuthOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock) : base(options, logger, encoder, clock)
        {
        }
