...
namespace Collabed.JobPortal.Web.Pages.Job.Edit
{
    ...
    public class PreviewModel : AbpPageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                updateJob.SalaryMaximum = SalaryMaximum != null ? SalaryMaximum : null;
                updateJob.SalaryMinimum = SalaryMinimum != null ? SalaryMinimum : null;
            }

            // HACK: Implement Suporting Documents appropriatelly and add Screening questions 
            var job = await _jobAppService.UpdateAsync(Reference, updateJob);
