...
namespace JobPortal.Jobs
{
	public class JobAppService : ApplicationService, IJobAppService
	{
		...
		public JobAppService(IJobRepository jobRepository, JobManager jobManager, IOrganisationRepository organisationRepository, ILogger<JobAppService> logger, IOptions<IdibuOptions> idibuOptions, IOptions<BroadbeanOptions> broadBeanOptions)
		{
